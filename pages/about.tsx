            ...
            <div className="flex flex-col gap-[3rem] justify-center m-auto max-w-[1200px] px-[20px] py-auto w-[1200px]">
                ...
                <div className="grid gap-[1em]">
                    ...
                    <h2 className="text-[#a2afd1] leading-[30px] text-justify font-[400]">
                        Disneflix is one of the best movie website that is accessible for everyone | This website is created for 100 Tula ni Stella Film Project in 21st century in the philippines and the world | We are the TPSians production team, and we are dedicated to bringing you one of the best student films you have ever seen.
                    </h2>
                </div>
