...
// Component
import VonImg from '../../public/img/Von.jpg'
    ...
    return (
        <ReactCardFlip
            ...
            <div className="card flex flex-col items-center rounded-[12px] p-5 text-white">
                ...
                <picture>
                    <img src={VonImg.src} className="rounded-[12px]" alt="" />
                </picture>

                <div className='flex gap-[0.8rem] flex-col '>
                    <h1 className='pt-[1rem] text-2xl m-auto'>Von</h1>
                ...
                <Modal isOpen={modalIsOpen} ariaHideApp={false} onRequestClose={closeModal} style={customStyles}>
                    <picture>
                        <img src={VonImg.src} className="rounded-[12px] h-[25rem]" alt="" />
                    </picture>
                    <button
                        onClick={closeModal}
